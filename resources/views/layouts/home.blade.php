                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right animated zoomIn">
                            <ul class="dropdown-user">
                                <li><a href="#"><i class="ti-user"></i> {{trans('message.user_profile')}}</a></li>
                                <li><a href="#"><i class="ti-settings"></i> {{trans('message.setting')}}</a></li>
                                <li><a href="#"><i class="fa fa-power-off"></i> {{trans('message.exit')}}</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li><a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-tachometer"></i>
                            <span
                                class="hide-menu">{{trans('message.counter')}}
                        </span></a>
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="/login">{{trans('message.login')}} </a></li>
                            <li><a href="/register">{{trans('message.register')}}</a></li>
                            <li><a href={{ route('logout') }}>{{trans('message.exit')}}</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-users"></i><span
                                class="hide-menu">کاربران</span></a>
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="{{route('admin.users')}}">{{ trans('message.user_list') }}</a></li>
                            <li><a href="{{route('admin.users.create')}}">{{trans('message.new_user')}} </a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-book"></i><span
                                class="hide-menu">{{trans('message.posts')}}
                        </span></a>
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="{{route('posts')}}">{{trans('message.posts_list')}}</a></li>
                            <li><a href="{{route('posts.create')}}">{{trans('message.new_post')}}</a></li>
                        </ul>
                    </li>
    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">{{trans('message.home')}}</a></li>
                    <li class="breadcrumb-item ">{{trans('message.counter')}}</li>
